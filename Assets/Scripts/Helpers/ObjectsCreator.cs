...
public class ObjectsCreator
{
		...
		where T:SpaceShip
	{
		...
		spaceship.InitSpaceShip(sdata.density, sdata.physicalParameters);
	...
	private static void CreateTurret(PolygonGameObject parent, TurretReferenceData pos, TurretSetupData data)
	{
		...
		turret.InitTurret (1f, smartAim, data.rotationSpeed, anglesRestriction);
	...
	public static Asteroid CreateAsteroid(AsteroidData data, AsteroidInitData initData, Material mat)
	{
		...
		asteroid.InitAsteroid (data.density, initData.speed, initData.rotation);
	...
	public static Asteroid CreateGasteroid(AsteroidInitData initData)
	{
		...
		asteroid.InitAsteroid (1f, initData.speed, initData.rotation);
	...
	public static SimpleTower CreateSimpleTower(TowerSetupData data)
	{
		...
		turret.InitSimpleTower (data.density, smartAim, data.rotationSpeed);
	...
	public static EvadeEnemy CreateEvadeEnemy(List<IBullet> bullets)
	{
		...
		enemy.InitEvadeEnemy (1, bullets);
		enemy.SetCollisionLayerNum (CollisionLayers.ilayerTeamEnemies);
